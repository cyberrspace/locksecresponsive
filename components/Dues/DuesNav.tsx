...
export default function DueNav() {
  ...
  return (
    <nav className="flex items-center justify-between w-full px-[16px]  mt-[0px] top-0 ">
      ...
      <div className="px-[16px]">
        <p className="text-gray-500 text-[12px] text-[#2C2C2C]">Pages / Payment Dues </p>
        <h2 className="text-[30px] font-bold text-[#2C2C2C]">Payment Dues</h2>
      </div>
